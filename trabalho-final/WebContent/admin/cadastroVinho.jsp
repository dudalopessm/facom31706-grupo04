...
<title>Cave Fontana - Cadastrar Vinho</title>
...
<div class="admin-layout">
  <div class="container" style="max-width:600px">
    ...
    <form action="../admin/vinho?acao=inserir" method="post" enctype="multipart/form-data" class="formulario" style="max-width:100%">
