        ...
        try {
            if ("inserir".equals(acao)) {
                ...
                if (dao.buscaPorCpf(cpf) != null) {
                    out.println("<p class='result-msg error'>Ja existe um cliente com o CPF " + cpf + ".</p>");
                } else {
                ...
                if (atual == null) {
                    out.println("<p class='result-msg error'>Cliente CPF " + cpf + " nao encontrado.</p>");
                ...
                if (dao.possuiPedidos(cpf)) {
                    out.println("<p class='result-msg info'>Nao e possivel remover: cliente possui pedidos cadastrados.</p>");
