...
import lab07.dao.CategoriaVinhoDao;
import lab07.modelo.CategoriaVinho;
        ...
        try {
            if ("inserir".equals(acao)) {
                ...
                if (dao.buscaPorNome(nome) != null) {
                    out.println("<p class='result-msg error'>Ja existe uma categoria com o nome \"" + nome + "\".</p>");
                } else {
                ...
                if (cat == null) {
                    out.println("<p class='result-msg error'>Categoria \"" + nomeOriginal + "\" nao encontrada.</p>");
                    ...
                    out.println("<p class='result-msg error'>Ja existe outra categoria com o nome \"" + novoNome + "\".</p>");
                } else {
                ...
                if (dao.possuiVinhos(nome)) {
                    out.println("<p class='result-msg info'>Nao e possivel remover: existem vinhos cadastrados nesta categoria.</p>");
                } else if (dao.removePorNome(nome)) {
                    out.println("<p class='result-msg success'>Categoria \"" + nome + "\" removida com sucesso!</p>");
                } else {
                    out.println("<p class='result-msg error'>Categoria \"" + nome + "\" nao encontrada.</p>");
                }
                ...
                if (c == null) {
                    ...
                    out.println("<table><tr><th>ID</th><th>Nome</th><th>Descricao</th></tr>");
